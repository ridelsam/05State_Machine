...
static QState Clock_Alarm_err_off(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_off::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_off::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
                status_ = Q_TRAN(&Clock_Alarm_err_on);
            }
...
static QState Clock_Alarm_err_on(Clock_Alarm * const me) {
    ...
    switch (Q_SIG(me)) {
        ...
        /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_on::TICK} */
        case TICK_SIG: {
            ++me->timeout;
            /*.${HSMs::Clock_Alarm::SM::Clock::Settings::setting_error::err_on::TICK::[me->timeout==10]} */
            if (me->timeout == 10) {
                me->timeout = 0;
